...
<div id="footer">
	<div class="wrapper">
		<div id="foo_widget1">
			...
			<?php endif; if(get_option('of_sn_widget') == 'true') { echo '<span class="widgetname">Footer1</span>'; } ?>
		</div>
		...
		<div id="foo_widget2">
			...
			<?php endif; if(get_option('of_sn_widget') == 'true') { echo '<span class="widgetname">Footer2</span>'; } ?>
			<div class="clear"></div>
		</div>
		...
		<div id="foo_widget3">	
			...
			<?php endif; 	if(get_option('of_sn_widget') == 'true') { echo '<span class="widgetname">Footer3</span>'; } ?>
		</div>
...
<div id="footer_data">
	<div class="wrapper">
		<div id="footer-left-side">
			...
			if( get_option('of_sn_footer_left') == 'true'){
				echo get_option('of_sn_footer_left_text');
			} else { 
			?>
		...
		<div id="footer-right-side">
			<?php /* Replace default text if option is set */
			if( get_option('of_sn_footer_right') == 'true'){ 
				echo get_option('of_sn_footer_right_text');
			} else {
				wp_loginout(); 
