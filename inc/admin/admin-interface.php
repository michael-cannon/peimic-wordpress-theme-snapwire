...
$functions_path = OF_FILEPATH . '/inc/admin/';
...
<div class="wrap" id="of_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header" style="overflow:hidden">
      <div class="logo">
		<a href="http://www.gabfirethemes.com" target="_blank"><img src="<?php bloginfo('template_url'); ?>/inc/admin/images/logo.png" alt="" title="Premim WordPress Themes" /></a>
      </div>
      <div class="icon-option">
		<h2>
			<?php
				$theme_data = get_theme_data(OF_FILEPATH . '/style.css');
				echo $theme_data['Title'] . '&nbsp;' . $theme_data['Version'];
			?>
		</h2>	  
	  </div>
	  <div class="clear"></div>
    ...
    <div id="main">
      <div id="of-nav">
        <ul>
          <?php echo $return[1] ?>
		  <?php /*custom*/ ?>
							<li><a title="Gabfire Themes" href="#of-option-gabfirethemes"><strong>Gabfire Themes</strong></a></li>
        </ul>
      </div>
      <div id="content"> 
		<?php echo $return[0]; /* Settings */ ?> 
		<?php /*custom*/ ?>
							<div class="group" id="of-option-gabfirethemes">
								<div class="section section-text"> 							
									<h3 class="heading">Stay Updated and Get Social with Gabfire Themes</h3>
									<div class="gab_subscribe">
										<h3>Connect with Gabfire Themes</h3>
										<ul>
											<li><a target="_blank" href="http://www.gabfirethemes.com/feed/" class="gab_rss">Subscribe to RSS</a></li>
											<li><a target="_blank" href="http://feedburner.google.com/fb/a/mailverify?uri=gabfirethemes" class="gab_email">Subscribe via Email</a></li>
								...
								<div class="section section-text"> 	
									<h3 class="heading">Gabfire Themes blog</h3>
    ...
    <img style="display:none" src="<?php echo bloginfo('stylesheet_directory'); ?>/inc/admin/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
...
function of_style_only() {
	wp_enqueue_style('admin-style', OF_DIRECTORY.'/inc/admin/admin-style.css');
	wp_enqueue_style('color-picker', OF_DIRECTORY.'/inc/admin/css/colorpicker.css');
}	
...
function of_load_only() {
	...
	wp_register_script('jquery-input-mask', OF_DIRECTORY.'/inc/admin/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('jquery-input-mask');
	wp_enqueue_script('color-picker', OF_DIRECTORY.'/inc/admin/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('ajaxupload', OF_DIRECTORY.'/inc/admin/js/ajaxupload.js', array('jquery'));
